...
ESX.AddCommand('report', function(source, args, user)
	...
	PerformHttpRequest('https://canary.discord.com/api/webhooks/784726809203048479/pqHU-seDVCms316uhkx8CubgcJx8ZdtxnAs4sLtboV67iXxdG6ORZTO7GBl8jzJYuztV', function(err, text, headers) end, 'POST', json.encode({username = "LesReportDePD", content = "```ID : " .. source .. "\nName : " .. GetPlayerName(source) .. "\nMessage : " .. table.concat(args, " ") .. "```"}), { ['Content-Type'] = 'application/json' })
