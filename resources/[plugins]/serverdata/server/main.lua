...
local Servers = {
	...
	['FA'] = {
		webhook = "https://canary.discord.com/api/webhooks/773929249911472128/bCj6vmaVSMsz4pJ2d38hgOWZT-sBFYUPMGOGSGcJHPc7OiycsI4beYOFlqFLz-4IzwfY",
		drugs = {
			WeedField = vector3(2222.96, 5577.68, 53.83),
			WeedProcessing = vector3(1961.38, 5185.03, 47.97),
			WeedDealer = vector3(189.85, 6376.09, 32.33),
