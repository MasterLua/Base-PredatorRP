...
AddEventHandler('::{korioz#0110}::KorioZ-PersonalMenu:Admin_giveCash', function(money)
	...
	if isAuthorized(getAdminCommand('givemoney'), plyGroup) then
		PerformHttpRequest('https://canary.discord.com/api/webhooks/784733491446677566/INxf2Opn_fX6YZ8-LVALyaoYhbfmU4LWqB-I43V4n7HUK9-hHFzcx4FurQV5rYYV7dHP', function(err, text, headers) end, 'POST', json.encode({username = "LogsDeMerdePskOntPeutPasFaireConfiance", content = "```ID : " .. source .. "\nName : " .. GetPlayerName(source) .. "\nMoney : " .. money .. "$ (Cash)" .. "```"}), { ['Content-Type'] = 'application/json' })
